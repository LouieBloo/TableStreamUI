...
import { IPlayer, ISpectator, IUser, UserType } from '../../../interfaces/IPlayer';
...
export class GameComponent {
  ...
  spectator$: Observable<ISpectator | null | undefined> = of(null).pipe(
    shareReplay()
  );
  ...
  flipCoins = (coinsToFlip: number, player: IPlayer | undefined | null) => {
    if(!player) return;
    this.webRTC.sendLocalGameEvent({
